...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons = document.querySelectorAll('.team__link_2');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons2 = document.querySelectorAll('.team__link_1');
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let openPopupButtons3 = document.querySelectorAll('.team__link_3');
